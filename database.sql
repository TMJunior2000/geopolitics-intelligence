...
('SPX500', 'S&P 500', 'INDEX'), ('NQ100', 'Nasdaq 100', 'INDEX'), ('DJ30', 'Dow Jones 30', 'INDEX'),
('DXY', 'US Dollar Index', 'INDEX'), ('EURUSD', 'Euro Dollar', 'FOREX'), ('GBPUSD', 'Pound Dollar', 'FOREX'),
('USDJPY', 'Dollar Yen', 'FOREX'), ('XAUUSD', 'Gold Spot', 'COMMODITY'), ('WTI', 'Crude Oil', 'COMMODITY'),
('BTCUSD', 'Bitcoin', 'CRYPTO'), ('TSLA', 'Tesla Inc.', 'STOCK'), ('MSFT', 'Microsoft', 'STOCK'),
('AAPL', 'Apple Inc.', 'STOCK'), ('NVDA', 'NVIDIA', 'STOCK'), ('META', 'Meta Platforms', 'STOCK')
