...
class TradingAccount:
    ...
    def get_account_info(self):
        ...
        Se siamo su Cloud -> Dati Finti (Simulazione $200).
        """
        ...
        # Simuliamo un conto piccolo da 200$ per far vedere la demo
        return {
            "balance": 200.0,
            "equity": 200.0,
            "floating_pl": 0.0,
            ...
            if positions:
                ...
                for p in positions:
                    formatted.append({
                        ...
                        "lots": p.volume,
                        "entry_price": p.open, # Nota: in alcune versioni è p.open, in altre p.price_open
